...
procedure leer2(var archivo: detail; var dato: empleado); //lee el archivo detalle
begin
...
procedure leer (var e: empleado); //lee por teclado empleado
begin
	with e do begin 
...
procedure crear (var arch_log: detail); //crea el archivo detalle
var e: empleado;
begin
    rewrite (arch_log);
    leer (e);
...
procedure reciboYCompacto (var maestro:master; var detalle:detail); //recibo y compacto (prodecimiento que pide el enunciado)
var
e:empleado;
c:compacto;
codActual:integer;
...
begin
	Assign (maestro, 'arc_compacto');
	Assign (detalle, 'arc_detalle');
	crear (detalle);
	writeln ('');
